...
LogEntryData CLogEngine::gen_data(cstr k0, cstr v0, cstr k1, cstr v1, cstr k2,
                                  cstr v2, cstr k3, cstr v3) {
  LogEntryData res;
...
CLogEngine::CLogEngine() { is_init = false; }

CLogEngine::~CLogEngine() { close(); }
